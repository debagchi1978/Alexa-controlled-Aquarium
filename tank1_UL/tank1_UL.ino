...
#define MyApiKey "ed87584c-b31b-430a-9335-da4fa6b2d4d9" // TODO: Change to your sinric API Key. Your API Key is displayed on sinric.com dashboard
...
void turnOn(String deviceId) {
  if (deviceId == "5ac321e4e53c0f14b41dba25") // Device ID of first device
  {  
    Serial.print("Turn on device id: ");
    Serial.println(deviceId);
    digitalWrite(lightPin, LOW);
  } 
  else if (deviceId == "5ad1a55008737a0cc268841f") // Device ID of second device
  { 
    Serial.print("Turn on device id: ");
    Serial.println(deviceId);
